...
var _hamburger = _interopRequireDefault(require("./modules/hamburger"));

var _slick = _interopRequireDefault(require("./modules/slick"));

var _filterToggle = _interopRequireDefault(require("./modules/filterToggle"));
...
var _mobileTabs = _interopRequireDefault(require("./modules/mobile-tabs"));
...
_slick.default.sliderInit();

_filterToggle.default.handler();
...
_mobileTabs.default.enable();

_mask.default.phone();

},{"./modules/filterToggle":6,"./modules/hamburger":7,"./modules/mask":8,"./modules/mobile-tabs":9,"./modules/modal":10,"./modules/price-range":11,"./modules/select":12,"./modules/slick":13}],6:[function(require,module,exports){
"use strict";
...
var accordeon = {
  handler: function handler() {
    var $this = $('.sidebar-filter__item-head'); // const $body = $('.sidebar-filter__item-body');

    var OPENED_CLASS = 'opened'; // alert('works');
    ...
    function sortMobileToggle() {
      $('#open_sort').on('click', function () {
        ...
        $('.catalog-sort__label').on('click', function () {
...
var _jquery = _interopRequireDefault(require("./../../../node_modules/inputmask/dist/jquery.inputmask"));
...
},{"./../../../node_modules/inputmask/dist/jquery.inputmask":1,"jquery":3}],9:[function(require,module,exports){
"use strict";
...
},{"ion-rangeslider":2,"jquery":3}],12:[function(require,module,exports){
"use strict";
